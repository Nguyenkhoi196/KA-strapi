...
export interface ApiIntroducePageIntroducePage extends Schema.SingleType {
  ...
  info: {
    singularName: 'introduce-page';
    pluralName: 'introduce-pages';
  ...
  attributes: {
    ...
    createdBy: Attribute.Relation<
      'api::introduce-page.introduce-page',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiSupplierSupplier extends Schema.CollectionType {
  ...
  attributes: {
    ...
    state: Attribute.Boolean & Attribute.Private & Attribute.DefaultTo<true>;
    products: Attribute.Relation<
      'api::supplier.supplier',
      'oneToMany',
      'api::product.product'
    >;
    loyalty: Attribute.Enumeration<['low', 'medium', 'high']>;
    locations: Attribute.Component<'information.location'>;
    contacts: Attribute.Component<'information.contacts'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    info: Attribute.DynamicZone<
      ['information.contacts', 'information.location']
    >;
